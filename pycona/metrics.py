...
class Metrics:
    ...
    def increase_ml_training_time(self, amount):
        """
        Increase the total ML training time.

        :param amount: The amount to increase by.
        """
        self.ml_training_time += amount

    def increase_ml_prediction_time(self, amount):
        """
        Increase the total ML prediction time.

        :param amount: The amount to increase by.
        """
        self.ml_prediction_time += amount
    ...
    def finalize_statistics(self):
        ...
        self.metrics_dict = {
            ...
            "ml_t_t": round(self.ml_training_time, 4),
            "ml_p_t": round(self.ml_prediction_time, 4),
