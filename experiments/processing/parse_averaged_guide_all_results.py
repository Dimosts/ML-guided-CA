...
def main():
    ...
    parser.add_argument('--input', type=str, default='experiments/aggregated_results/results_all_averaged_results.csv',
                      help='Path to the averaged results CSV file (default: experiments/aggregated_results/results_all_averaged_results.csv)')
    parser.add_argument('--output', type=str, default='experiments/parsed_results/parsed_guide_all_results.json',
                      help='Path to save the JSON output (default: experiments/parsed_results/parsed_guide_all_results.json)')
